...
const Footer = () => {
  return (
    <>
      <div className="bg-white-900  top-[20rem] z-50 border-t-4 ">
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 lg:px-8 ">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-1 lg:grid-cols-4 border-b-4 pb-5">
            <div>
              <div>
                <Link href="/">
                  <Image
              ...
              <p className="max-w-xs mt-4 text-sm text-black">INDONESIA.</p>
              <p className="max-w-xs mt-10 text-md text-black font-bold">
                FOLLOW US
              </p>
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-3 sm:grid-cols-1 lg:grid-cols-3">
              <div>
              ...
              <div>
                <p className="font-bold">Local Delivery Partners</p>
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-black">
                  <Link className="hover:opacity-75" href="#">
                    JNE
                  </Link>
